        ...
        "/api/v1/chats/{id}/messages": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Message ID для пагінації",
                        "name": "before",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/message.EditMessageRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.UsersRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "chat.ChatResponse": {
            ...
            "properties": {
                ...
                "last_message": {
                    "$ref": "#/definitions/models.LastMessage"
                },
                "members": {
                    "type": "array",
                    "items": {
